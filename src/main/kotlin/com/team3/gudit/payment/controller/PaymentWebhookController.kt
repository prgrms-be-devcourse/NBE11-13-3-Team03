...
@Tag(name = "Payment Webhook", description = "토스페이먼츠 결제 상태 변경 Webhook API")
@RestController
...
class PaymentWebhookController(
    ...
    fun handlePaymentStatusChanged(
