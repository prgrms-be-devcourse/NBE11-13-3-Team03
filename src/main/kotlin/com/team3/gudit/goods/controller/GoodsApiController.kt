...
class GoodsApiController(
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "400", description = "요청 값 또는 이미지 파일 형식이 올바르지 않음"),
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "401", description = "인증되지 않은 사용자"),
            ApiResponse(responseCode = "403", description = "상품 관리 권한 없음"),
        ],
    )
    @SecurityRequirement(name = "cookieAuth")
    @GetMapping("/admin")
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "400", description = "요청 값 또는 이미지 파일 형식이 올바르지 않음"),
            ApiResponse(responseCode = "401", description = "인증되지 않은 사용자"),
            ApiResponse(responseCode = "403", description = "상품 수정 권한 없음"),
            ApiResponse(responseCode = "404", description = "GOODS_001: 해당 상품을 찾을 수 없음"),
            ApiResponse(responseCode = "500", description = "이미지 저장 실패"),
        ],
    )
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "400", description = "요청한 상품 상태가 올바르지 않음"),
            ApiResponse(responseCode = "401", description = "인증되지 않은 사용자"),
            ApiResponse(responseCode = "403", description = "상품 상태 변경 권한 없음"),
            ApiResponse(responseCode = "404", description = "GOODS_001: 해당 상품을 찾을 수 없음"),
        ],
    )
    @SecurityRequirement(name = "cookieAuth")
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "401", description = "인증되지 않은 사용자"),
            ApiResponse(responseCode = "403", description = "상품 삭제 권한 없음"),
            ApiResponse(responseCode = "404", description = "GOODS_001: 해당 상품을 찾을 수 없음"),
        ],
    )
    @SecurityRequirement(name = "cookieAuth")
